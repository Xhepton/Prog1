/*
    g++ ch16drill.cpp Graph.cpp Window.cpp GUI.cpp Simple_window.cpp -o main `fltk-config --ldflags --use-images` -std=c++11
*/
...
//constructor that initalizes everything
...
//reading a pair of coordinates and update the Open_polyline
